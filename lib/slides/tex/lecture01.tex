...
\begin{frame}{Course Material}
	...
	\begin{center}
	  \url{https://github.com/UtrechtUniversity/KI1V13001-Inleiding-Logica}
	\end{center}
...
\begin{frame}{Logical Theory}
	...
	\begin{itemize}[<+->]
		...
		\item (1.1.4) We're talking \emph{about} logic (`object language') \emph{using} mathematics (`meta-language').
