...
\begin{frame}{0. Course Admin}
	...
	\begin{center}
		\begin{tabular}{c}
		\includegraphics[width=50ex]{itsinthesyllabus}\\
...
\begin{frame}{Admin Questions}

	If you’ve got any admin question (after today):
		\begin{itemize}[<+->]
	...
	Then, Dr. van der Gaast (\url{b.h.vandergaast@uu.nl}) is your man:

		\begin{center}
			\begin{tabular}{c c}
			 	\includegraphics[height=20ex]{brandt.jpeg} & \includegraphics[height=20ex]{johannes.jpeg} \\
				Your man & \emph{Not} your man!
			\end{tabular}
		\end{center}
...
\begin{frame}{Contact Me}
		...
		\begin{tabular}{l l }
			...
			Email: &\texttt{j.korbmacher@uu.nl}\\

			Phone (Office): &+31 (0) 30 253 7986\\

			Office Hours: & Thursdays, 2 pm -- 3 pm + by appointment\\
			...
			&\includegraphics[width=25ex]{JKH13.jpg}\\

		\end{tabular}

\begin{center}
Website: \begingroup\color{structure}\href{http://jkorbmacher.org}{http://jkorbmacher.org}\endgroup
\end{center}
