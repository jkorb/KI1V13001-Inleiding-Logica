			...
			\item \emph{Examples}:
				...
				\[\exists x\exists y(x\neq y\land \forall z(z=x\lor z=y))\]
				  ...
				  \item Here are some formulas in $\mathcal{L}_\in$:
						...
						In $\mathcal{L}_\in$, to make things more natural, we allow ourselves the notation $(t\in u)$ instead of the official ${\in}(t,u)$.
						When no confusion can arise, we shall sometimes omit the outermost parentheses.
						Our examples become:
						\[x\in x\]
...
\item[8.8.1] (a), (c), (e), (f), (h)

\item[8.8.2] (a), (b), (d), (e), (f)
